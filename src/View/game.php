...
<section id="game-recap-container" class="fullscreen-popup-container flex-center hidden" role="dialog" aria-modal="true" aria-labelledby="solution-name">
    <div class="popup-menu">
        ...
        <div id="user-controls" class="flex-center g1">
            <button id="new-game-btn" class="popup-menu-btn end-game-controls-btn" aria-label="Play Again">
                <svg class="end-game-controls" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0,0,256,256">
            ...
            <a href="<?= $basePath ?>" class="popup-menu-btn end-game-controls-btn" aria-label="Return to Home">
                <svg class="end-game-controls" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0,0,256,256">
